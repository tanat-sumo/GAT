"""NQ/MNQ sweep restricted to NY regular trading hours (9:30am-4pm ET) - the session filter
user says they actually use. Data is already US/Eastern tz from yfinance."""
import pandas as pd
import numpy as np
...
res.to_csv("data/sweep_nq_session_results.csv", index=False)
